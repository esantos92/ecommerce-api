...
RSpec.describe "Admin::V1::Users as :admin", type: :request do
  ...
  context 'GET /users' do
    ...
    it 'return all users' do
      get url, headers: auth_header(first_user)
  ...
  context 'POST /users' do
    ...
    context 'with valid params' do
      ...
      it 'adds a new user' do
        expect do
          post url, headers: auth_header(first_user), params: user_params
    ...
    context 'with invalid params' do
      ...
      it 'does not add a new user' do
        expect do
          post url, headers: auth_header(first_user), params: user_invalid_params
  ...
  context 'PATCH /users/:id' do
    ...
    context "with valid params" do
      let(:new_name) { 'My new username' }
      let(:user_params) { { user: { name: new_name } }.to_json }

      it 'updates user' do
        patch url, headers: auth_header(first_user), params: user_params
    ...
    context "with invalid params" do
      ...
      it 'does not update user' do
        ...
        patch url, headers: auth_header(first_user), params: user_invalid_params
  ...
  context 'DELETE /users/:id' do
    ...
    it 'removes user' do
      expect do
        delete url, headers: auth_header(first_user)
